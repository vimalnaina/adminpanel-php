<?php include("header_admin.php"); ?>
			<?php
				...
				if(strcmp($msg,"Update IT Advocate")==0){
					$sql="SELECT * FROM itadvocate_ WHERE it_adv_id=$key";
				...
				if(isset($_POST["it_adv_submit"])){
					...
					$sql = "INSERT INTO itadvocate_(name, comp_name, email, cont_person_1, mob_no_1, cont_person_2, mob_no_2) VALUES ('$name', '$comp_name', '$email', '$cont_person_1', '$mob_no_1', '$cont_person_2', '$mob_no_2')"; 
		
					if(mysqli_query($conn, $sql)){
						echo '<script type="text/javascript">
								location.replace("it_advocate.php");
							</script>';
					}
				...
				if(isset($_POST["it_adv_update"])){
					...
					$sql = "UPDATE itadvocate_ SET name='$name', comp_name='$comp_name', email='$email', cont_person_1='$cont_person_1', mob_no_1='$mob_no_1', cont_person_2='$cont_person_2', mob_no_2='$mob_no_2' WHERE it_adv_id=$key";
									...
									<div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="card-footer">
												<?php
													if(strcmp($msg,"Update IT Advocate")==0){
														echo "<button type='submit' name='it_adv_submit' class='btn btn-primary btn-sm' disabled>";
														echo "<i class='fa fa-dot-circle-o'></i> Submit</button>";
														echo "<button type='submit'  name='it_adv_update' class='btn btn-warning btn-sm'>";
														echo "<i class='fa fa-dot-circle-o'></i> Update</button>";
													}else{
														echo "<button type='submit' name='it_adv_submit' class='btn btn-primary btn-sm'>";
														echo "<i class='fa fa-dot-circle-o'></i> Submit</button>";
														echo "<button type='submit'  name='it_adv_update' class='btn btn-warning btn-sm' disabled>";
														echo "<i class='fa fa-dot-circle-o'></i> Update</button>";
													}
												?>
